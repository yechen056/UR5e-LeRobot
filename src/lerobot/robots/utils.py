...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "ur5e_pgi":
        from .ur5e_pgi import UR5ePGI

        return UR5ePGI(config)
    elif config.type == "bi_ur5e_pgi":
        from .bi_ur5e_pgi import BiUR5ePGI

        return BiUR5ePGI(config)
